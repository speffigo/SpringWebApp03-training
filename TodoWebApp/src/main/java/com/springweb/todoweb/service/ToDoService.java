...
public class ToDoService {
	...
	static {
		...
		todos.add(new ToDo("Ankit", ++todocount, "JAVA", LocalDate.now(), false));
		todos.add(new ToDo("Raj", ++todocount, "OS", LocalDate.now(), true));
		todos.add(new ToDo("Vikas", ++todocount, "AIML", LocalDate.now(), true));
	}
